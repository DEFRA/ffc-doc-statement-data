...
describe('loadIntermApplicationClaim', () => {
  ...
  test('should throw an error if multiple records are found', async () => {
    ...
    await expect(loadIntermApplicationClaim(startDate, transaction)).rejects.toThrow(
  ...
  test('should return if no records are found', async () => {
    ...
    await expect(loadIntermApplicationClaim(startDate, transaction)).resolves.toBeUndefined()
  ...
  test('should handle errors thrown by worker threads', async () => {
    ...
    await expect(loadIntermApplicationClaim(startDate, transaction)).rejects.toThrow('Worker processing failed')
  })
})
