...
describe('removeEtlIntermTotal', () => {
  ...
  test('calls the etlIntermTotal accessor without a transaction when none is provided', async () => {
    await removeEtlIntermTotal(paymentRefs)

    expect(mockDb.tables.etlIntermTotal).toHaveBeenCalledWith(undefined)
  })
