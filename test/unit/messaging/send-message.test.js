...
describe('send message', () => {
  ...
  test('should throw if sendMessage rejects', async () => {
    ...
    await expect(sendMessage(statement, type, config, options)).rejects.toThrow('send error')
  ...
  test('should throw if closeConnection rejects', async () => {
    ...
    await expect(sendMessage(statement, type, config, options)).rejects.toThrow('close error')
    expect(mockSendMessage).toHaveBeenCalled()
  })
  ...
  test('should propagate error if createMessage throws', async () => {
    ...
    await expect(sendMessage(statement, type, config, options)).rejects.toThrow('create error')
