...
const targetColumnNames = require('../target-column-names')
const config = require('../../config')
const { VARCHAR, NUMBER } = require('../target-column-types')
const { COMPANY_NAME, LOCATION_STREET, LOCATION_ZIP_CODE, LOCATION_CITY, INTERNET_EMAIL } = require('../fakers')
...
let sharedExcludedFields = []
if (config.etlConfig.excludeCalculationData) {
  sharedExcludedFields = [
