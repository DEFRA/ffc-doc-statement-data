...
const commonSchemas = {
  ...
  addressLine: (lineNumber) => Joi.string().max(MAX_ADDRESS_LINE_LENGTH).optional().allow('').messages({
    'string.base': `addressLine${lineNumber} should be a type of string`,
    'string.max': `addressLine${lineNumber} should have a maximum length of ${MAX_ADDRESS_LINE_LENGTH}`
  }),
