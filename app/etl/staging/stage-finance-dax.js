...
const mapping = [
  ...
  { column: sourceColumnNames.TRANSDATE, targetColumn: targetColumnNames.transdate, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.INVOICEDATE, targetColumn: targetColumnNames.invoicedate, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.MODIFIEDDATETIME, targetColumn: targetColumnNames.modifieddatetime, targetType: DATE, format: dateTimeFormat },
  { column: sourceColumnNames.MODIFIEDBY, targetColumn: targetColumnNames.modifiedby, targetType: VARCHAR },
  { column: sourceColumnNames.CREATEDDATETIME, targetColumn: targetColumnNames.createddatetime, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.CLAIMSETTLEMENTDATE, targetColumn: targetColumnNames.claimsettlementdate, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.EUYEARSTARTDATE, targetColumn: targetColumnNames.euyearstartdate, targetType: DATE, format: dateTimeFormat },
  { column: sourceColumnNames.EUYEARENDDATE, targetColumn: targetColumnNames.euyearenddate, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.POSTINGDATE, targetColumn: targetColumnNames.postingdate, targetType: DATE, format: dateTimeFormat },
  ...
  { column: sourceColumnNames.OEDATE, targetColumn: targetColumnNames.oedate, targetType: DATE, format: dateTimeFormat },
