...
const stageCSSContract = async () => {
  ...
  await storage.downloadFile(`${storageConfig.cssContract.folder}/export.csv`, tempFilePath)
  const columns = [
    'CHANGE_TYPE',
    'CHANGE_TIME',
    'PKID',
  ...
  return runEtlProcess({ tempFilePath, columns, table: cssContractTable, mapping, transformer })
}
