...
const { appsTypesDelinked } = require('../../constants/etl-tables')
...
const stageAppsTypes = async () => {
  ...
  const mapping = [
    ...
    { column: sourceColumnNames.WIN_OPEN_DATE, targetColumn: targetColumnNames.winOpenDate, targetType: DATE, format: monthDayYearDateTimeFormat },
    { column: sourceColumnNames.WIN_CLOSE_DATE, targetColumn: targetColumnNames.winCloseDate, targetType: DATE, format: monthDayYearDateTimeFormat }
  ]
  ...
  return downloadAndProcessFile('appsTypesDelinked', appsTypesDelinked, columns, mapping, excludedFields)
}
