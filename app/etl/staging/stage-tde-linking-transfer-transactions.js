...
const stageTdeLinkingTransferTransactions = async () => {
  ...
  const mapping = [
    ...
    { column: 'TRANSFEROR_PK_CUAA', targetColumn: 'transferor_pk_cuaa', targetType: 'number' },
    ...
    { column: 'TRANSFEREE_PK_CUAA', targetColumn: 'transferee_pk_cuaa', targetType: 'number' },
