...
const { cssContractApplicationsDelinked } = require('../../constants/etl-tables')
...
const stageCSSContractApplications = async () => {
  ...
  if (config.etlConfig.excludeCalculationData) {
    excludedFields = [
      ...
      targetColumnNames.typePCode,
      targetColumnNames.typeSCode,
  ...
  return downloadAndProcessFile('cssContractApplicationsDelinked', cssContractApplicationsDelinked, columns, mapping, excludedFields)
}
